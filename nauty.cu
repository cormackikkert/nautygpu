...
static volatile __managed__ TLS_ATTR set active[MAXM];     /* used to contain index to cells now
      ...
      set *ws_arg, int worksize, int m_arg, int n_arg, graph *canong_arg)
{
    ...
    DYNALLOC1GPU(set,active,active_sz,m,"nauty");
